...
|---|---|---|---|---|---|
| 1 | **Agent Infrastructure & Tooling** | 1.12 | 3/3 | — | Frameworks, MCP servers, agent-runtimes and dev-tooling that make on-chain agents buildabl |
...
### 2. DePIN Telecom Expansion — 0.87
...
### 3. Stablecoin Payment Rails — 0.58
...
### 4. On-Chain Gaming at Scale — 0.55

*Real games migrating player bases and economies fully on-chain (not just NFT skins).*

Detected via 2 dev signals (top: winsznx/bull-rush) + 8 media/KOL signals — cross-lane agreement: 2/3.
