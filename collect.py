...
SEARCH_QUERIES = [
    ...
    "solana passkey session key wallet",
    "solana points season quest airdrop",
    "solana intent RFQ protected swap execution",
    "solana token 2022 transfer hook compliance",
